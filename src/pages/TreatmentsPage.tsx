...
import { getTreatmentImage, isTreatmentDiagram, treatmentBySlug, treatmentGroups, treatmentImageClassName } from "../data/treatments";
        ...
        <section className="relative overflow-hidden bg-[#edf8f6]">
          ...
          <div className="mx-auto grid max-w-[1400px] items-center gap-12 px-5 py-16 sm:px-8 lg:grid-cols-[1.05fr_.95fr] lg:px-10 lg:py-24">
            <div>
              ...
              >
                Know what a procedure involves before you decide
              </motion.h1>
              ...
              >
                Each guide covers when a treatment is considered, what it
                involves, recovery and common questions. This is general
                education — personal advice always needs a consultation.
              </motion.p>
            </div>
            ...
            <div className="mx-auto max-w-[1400px] px-5 py-16 sm:px-8 lg:px-10 lg:py-20">
              ...
              <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
                {group.slugs.map((slug, index) => {
                  ...
                  const imageSrc = getTreatmentImage(treatment.slug, group.image);
                    ...
                    >
                      ...
                      >
                        <div className="relative h-48 overflow-hidden bg-slate-50">
                          ...
                          />
                          <div className={`absolute inset-0 ${isTreatmentDiagram(imageSrc) ? "bg-gradient-to-t from-slate-900/10 via-transparent to-transparent" : "bg-gradient-to-t from-slate-900/50 via-slate-900/10 to-transparent"}`} />
